...
<style>
    ...
    /* Tabs */
    button[data-baseweb="tab"] { color: var(--app-text) !important; }
    ...
    /* Sidebar navigation selector: no blue highlight */
    ...
    section[data-testid="stSidebar"] [data-baseweb="radio"] input:checked + div div,
    section[data-testid="stSidebar"] [data-baseweb="radio"] input:checked ~ div div {
    ...
    section[data-testid="stSidebar"] div[role="radiogroup"] label > div > div > div,
    section[data-testid="stSidebar"] div[role="radiogroup"] [aria-checked="true"],
    section[data-testid="stSidebar"] div[role="radiogroup"] [aria-checked="false"] {
        background: transparent !important;
    ...
    section[data-testid="stSidebar"] div[role="radiogroup"] div[aria-checked="false"] {
        background: transparent !important;
        box-shadow: none !important;
    }
